...
public class CursoAdicionar extends javax.swing.JDialog {
    ...
    public CursoAdicionar(java.awt.Frame parent, boolean modal, CursoController controller) {
        ...
        // 3. GUARDA O CONTROLLER NA VARIÁVEL
    ...
    private void btnCriarCursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCriarCursoActionPerformed
        ...
        // --- AQUI ESTÁ A MUDANÇA ---
        // Apagamos a linha "new CursoController();"
        // E usamos o 'this.cursoController' que veio do construtor
        
        try {
            this.cursoController.save(curso); // <--- USANDO O CONTROLLER CERTO
        ...
        } catch (Exception e) { // Use Exception genérica para pegar tudo
            JOptionPane.showMessageDialog(this, 
